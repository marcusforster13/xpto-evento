...
<head>
  ...
  <style>
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .tipo-btn:focus { outline: none; }
    .tipo-btn:focus:not(.active) { border-color: rgba(0,211,228,.5); background: rgba(255,255,255,.06); color: #fff; }
    ...
    .confirm-bar {
      ...
      border-top: 1px solid rgba(0,211,228,.25);
    ...
    .submit-btn:disabled { opacity: .45; cursor: not-allowed; background: rgba(0,211,228,.4); border: 1px solid rgba(0,211,228,.3); }
